                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form">
                                ...
                                <div class="form-group">
                                    <label>Kompi</label>
                                    <input type="text" class="form-control" id="peleton" name="peleton" maxlength="50" required autocomplete="off" placeholder="Tentukan nama peleton">
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
                ...
                success: function(result){
                    ...
                    if(result.success){
                        ...
                        $('#id_kompi').select2('trigger', 'select', {
                            data : {
                                id: result.data.id_kompi,
                                kompi: result.data.kompi
                            }
                        });
        ...
        select2Init("#id_kompi", "/kompi_all_select_get", null, function(data) { return data.kompi; }, function(data){ 
            if (data.id === '') { 
                return "Cari Kompi";
            }
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "kompi", orderable: true},
                {data: "peleton", orderable: true},
