                                ...
                                <div class="form-group">
                                	<div class="row">
                                		<div class="col-6">
                                    		...
                                    		<input type="text" class="form-control" id="id_kategori_pelanggaran" name="id_kategori_pelanggaran" required  placeholder="Kategori Pelanggaran">
                                		</div>
                                        <div class="col-6">
                                            <label for="id_karakter_penilaian">Karakter Penilaian</label>
                                            <input type="text" class="form-control" id="id_karakter_penilaian" name="id_karakter_penilaian" required placeholder="Kategori Penilaian">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="tel" class="form-control" id="no" name="no" required placeholder="Nomor">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
