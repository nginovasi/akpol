...
<script type="text/javascript">
    ...
    $(document).ready(function(){
                ...
                success: function(result){
                    ...
                    if(result.success){
                        ...
                        $('#id_batalyon').select2('trigger', 'select', {
                            data : {
                                id: result.data.id_batalyon,
                                batalyon: result.data.batalyon
                            }
                        });
        ...
        select2Init("#id_batalyon", "/batalyon_select_get", null, function(data) { return data.batalyon; }, function(data){ 
            if (data.id === '') { 
                return "Cari Batalion";
            }

            return data.batalyon; 
        });
