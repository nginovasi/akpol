                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            <th><span>#</span></th>
                                            <th><span>Variabel</span></th>
                                            <th><span>Indikator</span></th>
                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="indikator" name="indikator"  required placeholder="Tentukan indikator">
                                </div>
                                <div class="form-group">
                                    <label for="id_pen_kar_ref1">Variabel</label>
                                    <select class="form-control sel2" id="id_pen_kar_ref1" name="id_pen_kar_ref1" required>
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan indikator pujian',
