                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="karakter" name="karakter" required  placeholder="Karakter">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan data karakter',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus data karakter',
