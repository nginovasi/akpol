                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="jabatan" name="jabatan" required  placeholder="Masukan Jabatan">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan data jabatan',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus data jabatan',
