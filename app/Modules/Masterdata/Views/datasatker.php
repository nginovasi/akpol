                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="satker" name="satker" required  placeholder="Satuan Kerja">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.buttonExport = { "dom": "Bfrtip" , "buttons" : "['excelFlash', 'excel', 'pdf']" };


        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan satuan kerja',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus satuan kerja',
