                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label for="peleton">Kompi</label>
                                    <input type="text" class="form-control" id="peleton" name="peleton" maxlength="50" required autocomplete="off" placeholder="Tentukan nama kompi">
                                </div>
                                <div class="form-group">
