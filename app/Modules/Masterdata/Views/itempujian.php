                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control sel2" id="id_pen_kar_ref2" name="id_pen_kar_ref2" required>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="item_nilai">Item Nilai</label>
                                    <input type="text" class="form-control" id="item_nilai" name="item_nilai"  required placeholder="Tentukan item nilai">
                                </div>
...
<script type="text/javascript">
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "nama_pen_kar_ref2", orderable: true},
