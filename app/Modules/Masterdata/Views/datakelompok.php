                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kelompok" name="kelompok" maxlength="60" required autocomplete="off" placeholder="Tentukan nama kelompok">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="max_kapasitas" name="max_kapasitas" maxlength="3"  pattern="\d*" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" required autocomplete="off" placeholder="Tentukan max Kapasitas">
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan data kelompok',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus data kelompok',
