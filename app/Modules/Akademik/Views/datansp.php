...
<script type="text/javascript">
    ...
    const urldetail_tolak = '<?= base_url() . "/" . uri_segment(0) . "/action/" . uri_segment(1) . "detail_tolak" ?>';
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.success) {
                        ...
                        if (usertype=='trn') {
                            $("._data_id").attr('data-field','approvetrn_sts');
                        } else if (usertype=='btl') {
                            $("._data_id").attr('data-field','approvebtl_sts');
                        } else {
                            $("._data_id").attr('data-field','approvetrn_sts');
                        }
                    } else {
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "approvetrn_sts", orderable: true,
                    render: function (a, type, data, index) {
                        if (data.approvetrn_sts==0) {
                            return "Menunggu persetujuan";
                        } else if (data.approvetrn_sts==1) {
                            return "Disetujui";
                        } else if (data.approvetrn_sts==2) {
                            return "Ditolak";
                        } else {
