                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            <th><span>#</span></th>
                                            <th><span>Golongan / Kepangkatan</span></th>
                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label for="nama">Golongan / Kepangkatan</label>
                                    <input type="text" class="form-control" id="nama" name="nama" maxlength="50" required autocomplete="off" placeholder="Tentukan nama Golongan / Kepangkatan">
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan data golongan / kepangkatan',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus data golongan / kepangkatan',
