                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" maxlength="50" required autocomplete="off" placeholder="Tentukan nama program studi">
                                </div>
                                <div class="form-group">
                                    <label for="tahun_ajaran">Tahun Ajaran</label>
                                    <input type="text" class="form-control" id="tahun_ajaran" name="tahun_ajaran" maxlength="50" required autocomplete="off" placeholder="Tentukan tahun ajaran">
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        coreEvents.insertHandler = {
            placeholder : 'Berhasil menyimpan data program studi',
        ...
        coreEvents.deleteHandler = {
            placeholder : 'Berhasil menghapus data program studi',
