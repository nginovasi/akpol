...
<head>
  ...
  <meta name="description" content="Membuat informasi dapat diakses dan bermanfaat secara universal adalah tujuan utama kami di Google. Kami selalu menggunakan data untuk membuat layanan kami lebih canggih, lebih menyenangkan, dan berfungsi dengan lebih baik bagi pengguna kami. Namun, hal ini bersifat pribadi. Saat menggunakan layanan kami, pengguna memberi kami kepercayaan dan sudah menjadi tanggung jawab kami untuk menjaganya. Prinsip ini memandu karyawan, proses, dan produk kami dalam menjaga data pengguna tetap bersifat pribadi, aman dan dalam kendali mereka.">
  <script nonce="HQVcmR4ER7m9vV7KPyuEPA">
  ...
  <link href="https://safety.google/intl/id/principles/" rel="canonical">
  <link id="favicon" rel="shortcut icon" type="image/x-icon" sizes="32x32" href="favicons/images-favicon.ico">
  <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Roboto:100,300,400,500,700%7CGoogle+Sans:400,500%7CProduct+Sans:400&amp;lang=en" nonce="HQVcmR4ER7m9vV7KPyuEPA">
  <link href="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/css/css-index.min.css" rel="stylesheet" nonce="HQVcmR4ER7m9vV7KPyuEPA">
  <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/js-detect.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
  <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/picturefill-picturefill.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
...
<body>
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQZFTC9" height="0" width="0" style="display:none;visibility:hidden"></iframe>
  </noscript>
  <div class="glue-header h-c-header h-c-header--corporate-initiative">
    <main id="jump-content" class="sc-main">
      <section class="sc-intro">
        <div class="h-c-page">
         <!--  <img src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/images/qFzg_Zv9kjpGO5HXr0ZfWqOOnacwjiuJPyT8ZDger2hkqxWyo30Jt4jQDQUqJVVNgCv0KxfLlFuaf8b4LUu17E4yJimlDqm1Qcl16Q" class="sc-intro__pillar-icon" alt=""> -->
       
              <lottie-player src="https://assets5.lottiefiles.com/private_files/lf30_p8LAfk.json"  background="transparent"  speed="1" style="width: 60%; height: 60%; margin: 0 auto;"  loop  autoplay></lottie-player>
          <h1 class="h-c-headline h-c-headline--one sc-intro__headline">
      <span role="text">Prinsip Privasi dan <span class="-no-break">Keamanan Kami</span>
</span>


    </h1>
          <div class="sc-intro__copy"> <span role="text"><p align="justify">Kami membuat privasi yang berlaku bagi semua pengguna.  Tanggung jawab ini hadir seiring dengan dibuatnya produk dan layanan yang gratis dan dapat diakses oleh semua pengguna. Hal ini sangat penting karena kemajuan teknologi dan kebutuhan privasi terus berkembang. Kami ingin prinsip ini memandu produk, proses, dan karyawan kami dalam menjaga data pengguna tetap bersifat pribadi, aman, <span class="-no-break">dan terlindungi.</span>
            </p>
            </span>
          </div>
        </div>
        <picture>
          ...
          <source srcset="https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w1280, https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w2560 2x" media="(min-width: 1280px)">
            <source srcset="https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w1024, https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w2048 2x" media="(min-width: 960px)">
              <source srcset="https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w600, https://lh3.googleusercontent.com/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w600 2x">
                <!--[if IE 9]></video><![endif]-->
                <img src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/images/gvu1qHEx2wISdCa1q3k3LpGfhUxjFP-lsa5sLWIScmxX-JsQVO9ZN-ttZlOglSKlvpd263kVhA_ViP_vQf6CIsuHxXMXCZHJSUnC=w600" class="sc-intro__photo" alt="">
              </source>
            </source>
          </source>
        </picture>
      </section>
      <section class="sc-principles-container">
        <div class="h-c-page">
          <div class="h-c-grid" style="margin-top: -115px">
            <div class="h-c-grid__col h-c-grid__col--12 h-c-grid__col-l--8 h-c-grid__col-l--offset-2">
              <div data-glue-responsive-accordion-static data-glue-responsive-accordion-static-breakpoints="['x-small']" class="sc-principles">
                <ol class="sc-principles__list">
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-1" data-glue-zippy-expand>
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                  <span role="text">1. Kami menghormati pengguna dan <span class="-no-break">privasinya. </span>
</span>


                  <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mi-chevron"></use></svg></h2>
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Kami yakin bahwa ide-ide ini tidak terpisahkan. Ide-ide tersebut mewakili satu keyakinan inti yang telah memengaruhi semua produk yang kami buat sejak awal di Aplikasi SIAP AKPOL, dan produk yang akan kami buat ke depannya. Saat pengguna menggunakan produk kami, mereka mempercayakan informasinya kepada kami, dan sudah menjadi tugas kami untuk menjaganya. Ini berarti kami selalu bijaksana terkait data yang kami gunakan, cara menggunakan, dan <span class="-no-break">cara melindunginya.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-2">
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                  <span role="text">2. Kami menjelaskan data apa yang kami kumpulkan <span class="-no-break">beserta alasannya.</span>
</span>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Untuk membantu pengguna mengambil keputusan yang tepat terkait cara mereka menggunakan Aplikasi SIAP AKPOL, kami mempermudah pengguna untuk memahami tentang data apa yang kami kumpulkan, cara penggunaan, serta alasannya. Bersikap transparan berarti membuat informasi ini tersedia, dapat dipahami, dan dapat ditindaklanjuti <span class="-no-break">dengan mudah.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-3">
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                  <span role="text">3. Kami tidak pernah menjual informasi pribadi pengguna kami kepada <span class="-no-break">siapa pun.</span>
</span>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Kami menggunakan data agar Aplikasi SIAP AKPOL seperti infromasi data anda saat pengajuan sim untuk tes Kesehatan bermanfaat & berjalan semaksimal mungkin. Kami juga menggunakan data untuk menayangkan lebih banyak Data yang relevan. Meskipun Aplikasi ini membantu mendanai layanan kami dan menjadikannya gratis bagi semua pengguna, namun sangat perlu ditekankan bahwa informasi pribadi pengguna kami <span class="-no-break">tidak dijual.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-4">
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                  <span role="text">4. Kami memudahkan pengguna untuk mengontrol <span class="-no-break">privasi mereka.</span>
</span>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Kami tahu tidak ada satu solusi yang cocok bagi semua pengguna dalam hal privasi. Setiap Akun pada Aplikasi SIAP AKPOL dibuat dengan kontrol data aktif/nonaktif, sehingga pengguna kami dapat memilih setelan privasi yang tepat bagi mereka. Dan seiring berkembangnya teknologi, kontrol privasi kami juga berkembang, yang memastikan bahwa privasi selalu dikontrol <span class="-no-break">oleh pengguna.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-6">
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                  <span role="text">5. Kami membuat teknologi keamanan terkuat ke dalam <span class="-no-break">Aplikasi kami.</span>
</span>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Menghormati privasi pengguna kami berarti melindungi data yang dipercayakan kepada kami. Agar semua Aplikasi dan layanan SIAP AKPOL tetap aman, kami membangun dan menggunakan salah satu infrastruktur keamanan paling canggih di dunia. Ini berarti terus memperkuat teknologi keamanan internal kami guna mendeteksi dan melindungi terhadap ancaman online yang berkembang, sebelum ancaman tersebut menjangkau <span class="-no-break">pengguna kami.</span>
                          </span>
                        </p>
                      </div>
                    </div>
  ...
  l3.8-3.8H3.5V8.3h8.4L8.1,4.5L9,3.5L14.5,9L9,14.5z"></path>
    ...
    <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/lottie-lottie.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular-animate.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular-touch.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="http://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/js-index.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
</body>
