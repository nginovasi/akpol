            ...
            <div class="card-body">
                <div class="padding" >
                    <button class="btn btn-sm btn-outline-primary edit" title="Edit">
                                ...
                                <a onclick='return check()'>check</a>
                    <div >
                        <div id="asdd"></div>
                        <div id="asd"></div>
                ...
                success: function(result){
                    ...
                    if(result.success){
                                                                    ...
                                                                    tabel += '<tr data-time="">\
                                                                                    ...
                                                                                    if (isi.id_pertemuan==1) {
                                                                                        result.data.header.forEach (function(head) {
                                                                                            tabel += '<th scope="row" id='+list.tanggal+'_'+isi.id_pertemuan+'_'+head.id_kelompok+' >Olah Raga Pagi</th>';
                                                                                        })
                                                                                    } else if (isi.id_pertemuan==5) {
                                                                                        result.data.header.forEach (function(head) {
                                                                                            tabel += '<th scope="row" id='+list.tanggal+'_'+isi.id_pertemuan+'_'+head.id_kelompok+' >Isoma</th>';
                                                                                        })
                                                                                    } else {
                                                                                        result.data.header.forEach (function(head) {
                                                                                            tabel += '<td id='+list.tanggal+'_'+isi.id_pertemuan+'_'+head.id_kelompok+' rowspan="1"></td>';
                                                                                        })
                                                                                    }
                        ...
                        result.data.content.forEach(function(content) {
                            $('#'+content.tanggal+'_'+content.id_jam_pertemuan+'_'+content.id_kelompok_taruna).html('<div class="card-mapel">\
                                        <div class="infos">\
                                          <div class="">\
                                            <h2 class="name">'+content.kode_mk+' : <text style="font-weight: 400">32-18=14</text> </h2>\
                                            <h4 class="location">\
                                              <!-- <i class="fa fa-map-marker"></i> -->\
                                              KBP TOK satu ketut suitra atnyana koma S.I.K & tim \
                                            </h4>\
