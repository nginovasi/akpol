                        ...
                        tabel +='<table id="Scheduled" style="background-color: #f5f5f6 ; overflow-x: auto; ">\
                                    <thead>\
                                        <tr>\
                                            ...
                                            <th colspan="'+result.data.header.kelompok.length+'">Kelas</th>\
                                        </tr>\
                                        <tr>' ;
                                        result.data.header.kelompok.forEach (function(list) {
                                            tabel += '<th width="160px">'+list.kelompok+'</th>';
                                        })

                                        tabel +='\
                                        </tr>\
                                        <tr>' ;
                                        result.data.header.ruangan.forEach (function(list) {
                                            tabel += '<th width="160px">'+list+'</th>';
                                        })
