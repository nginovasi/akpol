    ...
    function loadTable(result) {
        ...
        hot = new Handsontable(container, {
            ...
            nestedHeaders: [
                ...
                ['#id', '#id_mata_pelajaran', '#id_user_taruna', '#id_semester', '#id_batalyon', '#tahun_ajaran', 'Nama Taruna', 'No AK', 'Kelompok', 'LJK', 'ESSAY', 'LJK', 'ESSAY', 'LJK', 'ESSAY', 'PROSJAR', 'TUGAS', 'HER', 'NILAI AKHIR', 'KATEGORI', 'BOBOT', 'KLASIFIKASI']
            ],
            columns: [{
                    data: 'id',
                    readOnly: true
            ...
            afterChange: function(change, source) {
                ...
                if (change[0][3] <= limitNilai && change[0][3] >= 0) {
                    const formData = {
                        ...
                        'her_ljk': rowData[13],
                        'her_esai': rowData[14],
                        'proses_ajar': rowData[15],
                        'tugas': rowData[16],
                        'her': rowData[17],
                        'nilai_akhir': rowData[18],
                        'kategori': rowData[19],
                        'bobot': rowData[20],
                        'klasifikasi': rowData[21]
                    };
                    $.ajax({
                        url: url_insert,
                        method: "POST",
