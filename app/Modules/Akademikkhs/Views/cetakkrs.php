            ...
            <div class="card-body">
                <div class="padding">
                    <div class="tab-content">
                        <form data-plugin="parsley" data-option="{}" target="_BLANK" id="forma" action="<?= base_url() ?>/akademikkhs/action/pdf/cetakkrs?o=P" method="GET" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="text-sm text-muted mb-4">Pilih semester dan klik tombol "Download PDF" untuk mencetak Kartu Rencana Studi per semester</div>
                                <div class="row">
                                    <div class="col-6">
                            ...
                            <div class="text-right">
                                ...
                                <!-- <button type="submit" class="btn btn-primary" id="btn1">satu</button> -->
                                <!-- <button type="submit" class="btn btn-primary" id="btn2">dua</button> -->
                            </div>
                        </form>
                    </div>
                </div>
