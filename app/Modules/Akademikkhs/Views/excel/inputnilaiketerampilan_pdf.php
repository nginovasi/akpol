...
<body>
	...
	<div style="margin-bottom: 20px">
		...
		<div class="">
			<h4 align="center" style="text-decoration: underline;" >NILAI KETERAMPILAN</h4>
		</div>
		<div class="">
			<table>
				<tr>
					...
					<?php
						...
						foreach ($data as $item) { $no++; ?>
							<tr>
								...
								<td align="right"><?=$item['praktek']?></td>
								<td align="right"><?=$item['proses_pelatihan']?></td>
								<td align="right"><?=$item['produk_pelatihan']?></td>
