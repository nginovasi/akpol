    ...
    function datatableColumn() {
        let columns = [{
            ...
            },
            {
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' +data.nap ? data.nap : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.nap ?  data.nap_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            {
                data: "npk",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.npk ? data.npk : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.npk ? data.npk_rank : 'Nilai Kosong'+ ')</div >'
                }
            },
            {
                data: "nsp",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.nsp ? data.nsp : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' +dat.nsp ? data.nsp_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            {
                data: "njk",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.njk ? data.njk : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' +data.njk ? data.njk_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            // {
            //     data: "id",
