            ...
            <div class="card-body">
                <div class="padding">
                    <div class="tab-content">
                        <form data-plugin="parsley" data-option="{}" id="forma" action="<?=base_url()?>/akademikkhs/action/pdf/cetakabsensiujian?o=P" method="GET" target="_BLANK" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control sel2" id="jenis_ujian" name="jenis_ujian" required>
