                ...
                <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="id_batalyon">Tingkat</label>
                                <ul class="list-unstyled text-sm mt-1 text-muted"></ul>
                                ...
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:150px;"><span>Semester</span></th>
                                            <th style="width:40px;"><span>NAP</span></th>
                                            <th style="width:40px;"><span>NPK</span></th>
                                            <th style="width:40px;"><span>NSP</span></th>
                                            <th style="width:40px;"><span>NJK</span></th>
                                    ...
                                    <div class="text-center">
                                        <div class="block d-inline-flex">
                                            <div class="p-4 p-sm-2 b-r">
                                                <div class="text-muted">Nilai Keseluruhan</div>
                                                <span class="h2" id="rerata_modal">30</span>
                                                <div class="py-4">
                                                    <small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="block d-inline-flex">
                                            <div class="p-4 p-sm-2 b-r">
                                                ...
                                                <div class="py-4">
                                                    <small class="text-muted">Kehadiran dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center">
                                <div class="block d-inline-flex">
                                    <div class="p-4 p-sm-2 b-r">
                                        ...
                                        <div class="py-4"><a href="#" class="btn btn-sm btn-rounded btn-outline-primary detail-nilai-toggle" data-idaspek="3" data-aspek="t_penilaian_aspek_karakter">Lihat Detail</a></div><small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                    </div>
                                    <div class="p-4 p-sm-2 b-r">
                                        <div class="text-muted">Nilai Pengetahuan</div>
                                        <span class="h2" id="pengetahuan_modal">30</span>
                                        <div class="py-4"><a href="#" class="btn btn-sm btn-rounded btn-outline-primary detail-nilai-toggle" data-idaspek="1" data-aspek="t_penilaian_aspek_pengetahuan">Lihat Detail</a></div><small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                    </div>
                                    <div class="p-4 p-sm-2 b-r">
                                        <div class="text-muted">Nilai Keterampilan</div>
                                        <span class="h2" id="keterampilan_modal">30</span>
                                        <div class="py-4"><a href="#" class="btn btn-sm btn-rounded btn-outline-primary detail-nilai-toggle" data-idaspek="2" data-aspek="t_penilaian_aspek_keterampilan">Lihat Detail</a></div><small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                    </div>
                                    <div class="p-4 p-sm-2 b-r">
                                        <div class="text-muted">Nilai Jasmani</div>
                                        <span class="h2" id="jasmani_modal">30</span>
                                        <div class="py-4"><a href="#" class="btn btn-sm btn-rounded btn-outline-primary detail-nilai-toggle" data-idaspek="5" data-aspek="t_penilaian_aspek_jasmani">Lihat Detail</a></div><small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                    </div>
                                    <div class="p-4 p-sm-2 b-r">
                                        <div class="text-muted">Nilai Kesehatan</div>
                                        <span class="h2" id="kesehatan_modal">30</span>
                                        <div class="py-4"><a href="#" class="btn btn-sm btn-rounded btn-outline-primary detail-nilai-toggle" data-idaspek="4" data-aspek="t_penilaian_aspek_kesehatan">Lihat Detail</a></div><small class="text-muted">Nilai dihitung untuk <strong class="smt-label">keseluruhan semester</strong></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="text-center">
                                <div class="block d-inline-flex">
                                    ...
                                    <div class="p-4 p-sm-4 b-r">
                                        <div class="text-muted">Tingkat</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.detail', function() {
            ...
            if ($('#id_tingkat').val()) {
                tampilData($('#id_batalyon').val(), $('#id_tingkat').val());
            }

        }).on('change', '#id_tingkat', function() {
            if ($('#id_batalyon').val()) {
                $('.smt-label').html($('#id_tingkat').select2('data')[0]['text'])
                tampilData($('#id_batalyon').val(), $('#id_tingkat').val());
            }
        })
        ...
        $('#d-excel').on('click', function(e) {
            $(this).attr("href", url_excel + "?o=P&id_batalyon=" + $('#id_batalyon').val() + '&id_tingkat=' + $('#id_tingkat').val());
            $(this).attr("target", "_blank");
        })

        $('#d-pdf').on('click', function(e) {
            $(this).attr("href", url_pdf + "?o=L&id_batalyon=" + $('#id_batalyon').val() + '&id_tingkat=' + $('#id_tingkat').val());
            $(this).attr("target", "_blank");
        })
        ...
        $('.detail-nilai-toggle').on('click', function(e) {
            ...
            tampilDetailNilai($(this).data('idaspek'), $(this).data('aspek'), $(this).data('id-taruna'), $('#id_tingkat').val())
        })
    ...
    function datatableColumn() {
        let columns = [{
            ...
            },
            {
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div class="item-except text-muted text-sm">' + data.semester.replace('/', '<br> ') + '</div >'
                }
            },
            {
                data: "rank_aspek",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.rank_aspek ? data.rank_aspek : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.rank_aspek ? data.rank_aspek_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            {
                data: "rank_peng_ket",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.rank_peng_ket ? data.rank_peng_ket : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.rank_peng_ket ? data.rank_peng_ket_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            {
                data: "rank_karakter",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.rank_karakter ? data.rank_karakter : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.rank_karakter ? data.rank_karakter_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            {
                data: "rank_jas_kes",
                ...
                orderable: true,
                render: function(a, type, data, index) {
                    return '<div href = "#"class = "item-title text-color" > ' + data.rank_jas_kes ? data.rank_jas_kes : 0 + ' </div>' +
                        '<div class="item-except text-muted text-sm h-1x">Rank(' + data.rank_jas_kes ? data.rank_jas_kes_rank : 'Nilai Kosong' + ')</div >'
                }
            },
            // {
            //     data: "id",
    ...
    function tampilData(batalyon, tingkat) {
        ...
        if (tingkat != null) {
            $('#_gender').html('Tingkat : ' + $('#id_tingkat').select2('data')[0]['text']);
        }
    ...
    function tampilDetailNilai(id_aspek, aspek, id_taruna, id_tingkat) {
            ...
            success: function(result) {
                if (result.success) {
                    if (result.data) {
                        ...
                        $('#semester_detail').html($('#id_tingkat').select2('data')[0]['text'].replace('Semester ', ''));
