                        ...
                        success: function(result){
                            ...
                            if(result.success){
                                ...
                                if(result.data.header.length==0) {
                                  ...
                                  tabel +='<table class="table table-striped table-bordered" style="width : 0 ;">\
                                              <thead class="cal-thead">\
                                                  ...
                                                  tabel +='\
                                                    ...
                                                    <tr class="row2">\
                                                      ...
                                                      dataStart = 0;
                                                  result.data.header.forEach (function(list) {
                                                      tabel += '<th class="cal-toprow" style="background-color: '+colorTabelfooter[dataStart]+' !important;">'+list.nama_ruangan+'\
                                                        </th>';
                                                        dataStart++;
