                ...
                success: function(result) {
                    if (result.success) {
                        if (result.data.length > 0) {
                            ...
                            $('#input-title').show();
                            $('#input-title').html('Daftar nilai taruna Batalyon <strong>' + nama_batalyon + ' Aspek Kesehatan </strong>');
                            $('#d-pdf').show();
                        } else {
    ...
    function loadTable(result) {
        ...
        hot = new Handsontable(container, {
            ...
            nestedHeaders: [
                ...
                ['#id', '#id_mata_pelajaran', '#id_user_taruna', '#id_semester', '#id_batalyon', '#batas_her', 'Nama Taruna', 'No AK', 'Kelompok', 'RIKESLA', 'INSIDENTIL', 'YATKES', 'KESWA', 'NILAI AKHIR', 'KATEGORI', 'BOBOT', 'KLASIFIKASI']
            ],
            columns: [{
                    data: 'id',
                    readOnly: true
