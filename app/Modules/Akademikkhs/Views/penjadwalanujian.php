    ...
    <div class="page-content page-container" id="page-content">
                            ...
                            <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="hidden" id="is_ujian" name="is_ujian" value="1">
        ...
        <div class="card" id="card_table_jadwal" style="display: none">
            <div class="card-body">
              <br>
              <div>
                <div style="text-align: center;" ><h3 style="font-size: 1rem" id="_batalyon"></h3></div>
                <div style="text-align: center;" ><h3 style="font-size: 1rem" id="_periode"></h3> </div>
                                              ...
                                              result.data.body.forEach (function(list) {
                                                                      ...
                                                                      var orderobj = obj.sort((a, b) => parseFloat(a.jam_mulai) - parseFloat(b.jam_mulai));
                                                                          orderobj.forEach (function(isi) {
                                                                              ...
                                                                              if (isi.id_pertemuan==1) {
                                                                                tabel += '<td class="cal-userinfo" style="height : 45px" align="center">'
                                                                              } else if (isi.id_pertemuan==5) {
                                                                                tabel += '<td class="cal-userinfo" style="height : 45px" align="center">'
                                                                              } else {
                                                                                tabel += '<td class="cal-userinfo"align="center" >'
                                                                              }
                                                    ...
                                                    ';
                                                                if (isi.id_pertemuan==1) {
                                                                    ...
                                                                    result.data.header.forEach (function(head) {
                                                                        tabel += '<td class="weekend ui-userinfo" style="height : 45px; text-align: center; padding: 11px !important; background : #d9d9d9" >Isoma</td>';
                                                                    })
                                                                } else {
                                                                      dataStart = 0;
                                                                    result.data.header.forEach (function(head) {
                                                                      if (list.kunci==1) {
                                                                        ...
                                                                        tabel += '<td class="ui-droppable" style="background-color: '+colorTabel[dataStart]+' !important;" data-date="'+list.tanggal+'" data-unit="'+isi.id_pertemuan+'" data-kelompoktaruna="'+head.id_kelompok+'"\
                                                                          data-namakelompoktaruna="'+head.nama_kelompok.replaceAll(' ', '_')+'" id='+list.tanggal+'_'+isi.id_pertemuan+'_'+head.id_kelompok+'\
