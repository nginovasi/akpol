...
<body>
	...
	<div style="margin-bottom: 20px">
		...
		<div class="">
			<h4 align="center" style="text-decoration: underline; text-transform: uppercase;" >RANKING TARUNA Per Tingkat</h4>
		</div>
		<!-- <div class="">
			<table >
				<tr>
					...
					<?php
						...
						foreach ($data as $item) { $no++; ?>
							<tr>
								...
								<td><?=$item['batalyon']?></td>
                                <td><?=$item['semester']?></td>
								<td align="right"><?=$item['rank_aspek'].'<br>('.$item['rank_aspek_rank'].')'?></td>
								<td align="right"><?=$item['rank_peng_ket'].'<br>('.$item['rank_peng_ket_rank'].')'?></td>
								<td align="right"><?=$item['rank_karakter'].'<br>('.$item['rank_karakter_rank'].')'?></td>
								<td align="right"><?=$item['rank_jas_kes'].'<br>('.$item['rank_jas_kes_rank'].')'?></td>
							</tr>
					<?php } ?>
				</tbody>
			</table>
