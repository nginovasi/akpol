				...
				<tbody>
					...
					<tr>
						...
						<td colspan="4"><?php if (isset($data[0]['rata_pengetahuan'])) {
							echo round($data[0]['rata_pengetahuan'], 2)==0? '' : round($data[0]['rata_pengetahuan'], 2);
						}  ?></td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="4"><?php if (isset($data[0]['rata_keterampilan'])) {
							echo round($data[0]['rata_keterampilan'], 2)==0? '' : round($data[0]['rata_keterampilan'], 2);
						}  ?></td>
					</tr>
				</tbody>
			</table>
			...
			<table width="100%" border="1" class="tb-aspek">
				<thead>
					<tr>
						...
						<th align="right"><?php if (isset($data[0]['rata_keterampilan'])) { echo round(($data[0]['rata_pengetahuan']+$data[0]['rata_keterampilan']+$data[0]['rata_karakter']+$data[0]['rata_kesehatan']+$data[0]['rata_jasmani'])/5, 2)==0? '' : round(($data[0]['rata_pengetahuan']+$data[0]['rata_keterampilan']+$data[0]['rata_karakter']+$data[0]['rata_kesehatan']+$data[0]['rata_jasmani'])/5, 2); } ?></th>
					</tr>
				</thead>
			</table>
		</div>
