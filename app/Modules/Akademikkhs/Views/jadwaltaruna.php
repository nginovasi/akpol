                        ...
                        success: function(result){
                            ...
                            if(result.success){
                                ...
                                if(result.data.header.length==0) {
                                  ...
                                  $('#headernya').html('<h3 style="font-size:0.8rem">JADWAL MATA PELAJARAN</h3> <h3  style="font-size:0.8rem">KELOMPOK '+ result.data.header['0'].nama_kelompok +' </h3>  <h3  style="font-size:0.8rem">PERIODE '+result.data.tgl_akhir+' </h3> ');
